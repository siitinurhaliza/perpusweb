   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/agama'">
            Agama (<?= $totalAgama; ?>)
         </button>
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['agama'] as $agama) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $agama['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $agama['foto']; ?>" class="card-img-top" alt="Cover agama">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $agama['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $agama['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $agama['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
