...
<body>
   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         <h2>Categories</h2>
         <div class="btn-group">
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/katalog'">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['buku'] as $buku) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $buku['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $buku['foto']; ?>" class="card-img-top" alt="Cover Buku">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $buku['judul']; ?></h5>
