   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/seni'">
   ...
   <div class="services_section">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['seni'] as $seni) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $seni['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $seni['foto']; ?>" class="card-img-top" alt="Cover seni">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $seni['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $seni['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $seni['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
