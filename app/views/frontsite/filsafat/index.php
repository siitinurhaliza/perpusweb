   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/filsafat'">
            ...
            <button class="btn" onclick="window.location.href='<?= BASEURL; ?>/frontsite/bahasa'">
            Bahasa (<?= $totalBahasa; ?>)
         </button>
   ...
   <div class="services_section">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['filsafat'] as $filsafat) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $filsafat['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $filsafat['foto']; ?>" class="card-img-top" alt="Cover filsafat">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $filsafat['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $filsafat['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $filsafat['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
