   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/sejarah'">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['sejarah'] as $sejarah) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $sejarah['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $sejarah['foto']; ?>" class="card-img-top" alt="Cover sejarah">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $sejarah['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $sejarah['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $sejarah['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
