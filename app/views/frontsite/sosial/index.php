   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/sosial'">
   ...
   <div class="services_section">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['sosial'] as $sosial) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $sosial['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $sosial['foto']; ?>" class="card-img-top" alt="Cover sosial">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $sosial['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $sosial['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $sosial['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
