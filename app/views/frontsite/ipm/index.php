   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/ipm'">
   ...
   <div class="services_section">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['ipm'] as $ipm) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $ipm['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $ipm['foto']; ?>" class="card-img-top" alt="Cover ipm">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $ipm['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $ipm['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $ipm['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
