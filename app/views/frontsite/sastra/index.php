   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/sastra'">
   ...
   <div class="services_section">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['sastra'] as $sastra) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $sastra['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $sastra['foto']; ?>" class="card-img-top" alt="Cover sastra">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $sastra['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $sastra['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $sastra['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
