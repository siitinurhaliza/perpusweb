   ...
   <div class="services_section" style="margin-top: 30px;">
      <div class="category-container">
         ...
         <div class="btn-group">
            ...
            <button class="btn active" onclick="window.location.href='<?= BASEURL; ?>/frontsite/ipt'">
   ...
   <div class="services_section">
      ...
      <div class="container mt-5">
         <div class="row" id="bookContainer">
            <?php foreach ($data['ipt'] as $ipt) : ?>
               <div class="col-md-3 mb-3 book-card" data-category="<?= $ipt['kategori']; ?>">
                  <div class="card">
                     <img src="<?= BASEURL; ?>/public/assets/frontsite/img/foto_profile/<?= $ipt['foto']; ?>" class="card-img-top" alt="Cover ipt">
                     <div class="card-body">
                        <h5 class="card-title large-text"><?= $ipt['judul']; ?></h5>
                        <p class="card-text">Pengarang: <?= $ipt['pengarang']; ?></p>
                        <!-- <p class="card-text">Tahun Terbit: <?= $ipt['tahunterbit']; ?></p> -->
                     </div>
                  </div>
               </div>
            <?php endforeach; ?>
